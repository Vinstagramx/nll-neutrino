...
nll_obj = NLL(energies = en_array, event_rates = event_no, mix_ang = mix_ang, distance = L, sq_mass_diff = sq_mass_diff)
...
for ind, val in enumerate(mix_ang_arr):
    nll_obj_t = NLL(energies = en_array, event_rates = event_no, mix_ang = val, distance = L, sq_mass_diff = sq_mass_diff)
...
for ind, val in enumerate(sq_mass_arr):
    nll_obj_m = NLL(energies = en_array, event_rates = event_no, mix_ang = mix_ang, distance = L, sq_mass_diff = val)
...
for ind, val in enumerate(dist_arr):
    nll_obj_d = NLL(energies = en_array, event_rates = event_no, mix_ang = mix_ang, distance = val, sq_mass_diff = sq_mass_diff)
...
"""
num_thetas = 200  # Number of mixing angles (θ_23) to investigate
...
for ind, val in enumerate(theta_arr):
    ...
    nll_theta = NLL(energies = en_array, event_rates = event_no, mix_ang = val, distance = L, sq_mass_diff = sq_mass_diff)
    nll_theta.surv_prob()
